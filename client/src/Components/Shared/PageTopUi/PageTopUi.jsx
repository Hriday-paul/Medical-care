...
const PageTopUi = ({children}) => {
    return (
        <div className="relative">
            <img className="w-full h-[40vh] md:h-[55vh] lg:h-[60vh] brightness-50" src={`https://res.cloudinary.com/devlj6p7h/image/upload/v1710565625/test/qqwid0ueckoamuakbhag.jpg`} alt="banner image" />
